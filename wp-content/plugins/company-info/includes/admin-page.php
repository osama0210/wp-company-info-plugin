...
function ci_register_admin_menu(): void {
	add_menu_page(
		...
		'company-info',
		'ci_render_admin_page', // Callback function to display the page content
		'dashicons-building',
		60
	);
}
...
add_action('admin_menu', 'ci_register_admin_menu'); // Hook to add the menu item to the WordPress dashboard

add_action('admin_init', 'ci_register_settings'); // Hook to register settings, sections, and fields during admin initialization
